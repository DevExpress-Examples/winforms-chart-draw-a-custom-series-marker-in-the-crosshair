...
Namespace CustomDrawCrosshairSample
    ...
    Public Partial Class Form1
        ...
        Private bitmapCache As Dictionary(Of String, Bitmap) = New Dictionary(Of String, Bitmap)()
                ...
                For Each element As CrosshairElement In group.CrosshairElements
                    ...
                    If Not bitmapCache.TryGetValue(element.Series.Name, image) Then
                        ...
                        Using graphics As Graphics = Graphics.FromImage(image)
                            Using brush As SolidBrush = New SolidBrush(element.LabelElement.MarkerColor)
